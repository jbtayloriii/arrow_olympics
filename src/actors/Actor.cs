...
public class Actor {
    ...
    public void RenderHitbox(Batcher batcher) => Hitbox.Render(batcher);
    ...
    public virtual void Update() {
        // Console.WriteLine($"Updating actor with velocity: {Velocity}");
        if (Velocity != Vector2.Zero) {
            Move(Velocity * Time.Delta);
            // Console.WriteLine($"Updated position: {Position}");
    ...
    public virtual void Render(Batcher batcher) {
        ...
        //     batcher.Image(frame.Subtexture, Vector2.Zero, sprite.Origin, Vector2.One, 0, Color.White);
        // }
    }
